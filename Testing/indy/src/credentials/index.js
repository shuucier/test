...
exports.acceptRequest = async function(theirDid, encryptedMessage) {
    ...
    for(let attr of schema.attrNames) {
        ...
        switch(attr) {
            case "name":
                value = await indy.pairwise.getAttr(theirDid, 'name');
                break;
            case "ic":
                value = "991231-14-2930";
                break;
            case "address":
                value = "Kampus Utama, Jalan Genting Kelang, 53300 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur";
                break;    
            case "age":
                value = "21";
                break;
            ...
            case "workingyear":
                ...
                break;
            case "school":
                value = "Tunku Abdul Rahman University College";    
                break; 
            case "specialize":
            ...
            case "policyNumber":
                ...
                break; 
            case "effectiveDate":
                value = "20 January 2018 - 20 January 2038";    
                break;                                       
            default:
                value = "someValue";
        }
